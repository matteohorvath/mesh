...
export default function Home() {
  ...
  return (
    <main className="mt-4">
      ...
      <section
        id="philosophy"
        className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-card/30 to-card/10 px-4 py-8 overflow-hidden"
      >
      ...
      <section
        id="agreement"
        className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-background/80 overflow-hidden"
      >
        {/* Animated background elements */}
      ...
      <section
        id="projects"
        className="min-h-screen flex items-center justify-center bg-card/30 px-4 py-8"
      >
