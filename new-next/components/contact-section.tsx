      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2
              className={cn(
                "text-center text-3xl md:text-5xl font-bold mb-6 transition-all duration-700",
                isVisible
            ...
            <div className="mx-auto w-24 h-1 bg-gradient-to-r from-primary to-accent rounded-full mb-8"></div>
          </div>
          <div
            className={cn(
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p>matteo.horvath@growmesh.io</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  />
                  <div>
                    <p>Bartók Béla út 51., 1114 Budapest, Hungary</p>
                  </div>
                </div>
              </div>

              <div className="aspect-w-16 aspect-h-9 bg-gradient-to-br from-primary/10 to-accent/10 rounded-sm overflow-hidden border border-border">
                <iframe
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-primary to-accent text-primary-foreground py-3 px-8 text-lg hover:from-primary hover:to-primary transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background rounded-md shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  <svg
