...
const AboutSection = ({ scrollToJoin }: { scrollToJoin: () => void }) => {
  ...
  return (
    <section
      id="about"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-card/30 to-background/80 py-20"
    >
          ...
          >
            <div className="prose prose-lg prose-invert max-w-none space-y-4">
              ...
              <Link
                ...
                href="https://www.matteo.chat/mesh-retro"
                target="_blank"
              >
